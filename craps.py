"""
Entry point module for the Craps table simulator.

Organizes the usage of other project modules to facilitate the simulation
loop execution and handles loop entry/exit.
"""
...
class Craps:
    """
    Simulation loop orchestrator class.
    ...
    def __init__(self) -> None:
        """
        Initialization method for the Craps class.

        Initializes the simulator attributes and tracks state during the
        gameplay loop."""
...
def main() -> None:
    ...
    Creates a Craps instance, calls for the start of a simulation loop,
    and catches a custom quit exception.
    """
